...
def main() -> None:
    ...
    parser.add_argument(
        "--reliability", type=Path, default=Path("conductor/bluesky_mirror_reliability_status.json")
    )
    parser.add_argument(
        "--empty-matrix",
        type=Path,
        default=Path("conductor/archive/bluesky_mirror_empty_matrix_noop_20260727/metadata.json"),
    )
    parser.add_argument(
        "--recovery",
        type=Path,
