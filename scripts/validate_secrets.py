...
def validate_environment(
    ...
    *,
    ...
    valid = not missing_required and not json_errors and (not any_of or bool(satisfied_groups))
...
def main() -> None:
    ...
    result = validate_environment(args.mode, schema=load_schema(args.schema))
    if args.json:
