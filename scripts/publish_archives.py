...
def _build_dataset_card(manifest: dict[str, Any]) -> str:
    ...
    return (
        ...
        "The repository owner has approved this corpus for publication. The "
        "`license: other` metadata is intentional: repository code licensing does "
        "not replace source-specific rights, notices, or platform terms attached "
        "to individual records. Provenance fields identify the source and capture "
        "method so downstream users can assess reuse conditions.\n\n"
        "## Intended Use\n\n"
        "This corpus supports research, public-record preservation, reproducibility, "
        "and auditing of New Zealand government communications. It is not an "
        "authoritative government record, an endorsement of archived content, or "
        "a basis for automated decisions about individuals.\n\n"
        "## Limitations\n\n"
        "Coverage varies by agency, platform, source availability, and capture "
        "method. Deleted, edited, access-controlled, or platform-restricted material "
        "may be absent. Users should validate records against authoritative sources "
        "when accuracy or currency is material.\n\n"
        "## Update Cadence and Persistence\n\n"
        "Hugging Face is the rolling dataset surface updated through reviewed "
        "publication workflows. Zenodo provides immutable versioned snapshots with "
        "DOIs; the current release evidence is recorded in the owning repository.\n\n"
        "## Known Gaps\n\n"
        f"{gap_lines}\n"
    )
