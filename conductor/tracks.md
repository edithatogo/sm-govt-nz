...
- Hugging Face: monthly rolling update via scheduled Publish Archives (target: huggingface)
- Zenodo: manual release snapshot lane, with monthly reviewed release snapshots gated by publish-zenodo-doi confirmation
...
## [x] Track: Complete archival coverage for all identified government sources
